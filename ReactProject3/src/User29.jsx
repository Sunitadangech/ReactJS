...
const User29 = () => {
    let [user,setUser]=useState({
         profile:"https://img.jagranjosh.com/imported/images/E/GK/Shivaji-Maharaj-biography-and-amazing-facts.jpg",
    ...
    let changeUser = () => {
        setUser({
            profile:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJKjKUeLYpzWmDP_MZvbMmJdOuy8uxbb9uCg&s",
            name:"Chatarpati Shivaji Maharaj",
            age:50,
        })
    }
